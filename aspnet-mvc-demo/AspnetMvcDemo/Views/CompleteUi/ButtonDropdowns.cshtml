<div class="ui-block">
    <h3 class="ui-block-heading">Button dropdowns</h3>

    <h4 class="ui-block-heading">Variations</h4>

    <div class="cui-example cui-example-inline-spacing" id="button-dropdowns-demo">
        <div class="btn-group">
    ...
    <h4 class="ui-block-heading">Hidden arrow</h4>

    <div class="cui-example cui-example-inline-spacing" id="button-dropdowns-no-arrow-demo">
        <div class="btn-group">
    ...
    <h4 class="ui-block-heading">Split</h4>

    <div class="cui-example cui-example-inline-spacing" id="split-button-dropdowns-demo">
        <div class="btn-group">
    ...
    <div class="cui-example cui-example-vertical-spacing-sm" id="sizes-button-dropdowns-demo">
        <div class="btn-group">
