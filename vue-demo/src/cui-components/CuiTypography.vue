<template>
  <div class="ui-block">
    <h3 class="ui-block-heading">Typography</h3>

    <h4 class="ui-block-heading">Headings</h4>
    ...
    <h4 class="ui-block-heading">Display headings</h4>
    ...
    <h4 class="ui-block-heading">Paragraph</h4>
    ...
    <h4 class="ui-block-heading">Inline text elements</h4>
    ...
    <h4 class="ui-block-heading">Abbreviations</h4>
    ...
    <h4 class="ui-block-heading">Addresses</h4>
    ...
    <h4 class="ui-block-heading">Blockquotes</h4>
    ...
    <h4 class="ui-block-heading">Lists</h4>
    ...
    <h4 class="ui-block-heading">Code</h4>
    ...
    <h4 class="ui-block-heading">Jumbotron</h4>
    ...
    <h4 class="ui-block-heading">Figures</h4>

    <div class="cui-example">
      <figure class="figure" style="max-width: 25rem">
        <img :src="`${baseUrl}img/bg/1.jpg`" class="figure-img img-fluid" alt="A generic square placeholder image with rounded corners in a figure.">
