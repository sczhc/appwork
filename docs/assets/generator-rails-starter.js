...
var ASSETS_RB_TEMPLATE = document.getElementById('template__assets-rb').value;
  ...
  methods: {
    generate: function() {
      this.originalContent = generatorParse({
        'config/initializers/assets.rb': { template: ASSETS_RB_TEMPLATE },
      ...
      this.tabContent = {
        'config/initializers/assets.rb': generatorHighlight(this.originalContent['config/initializers/assets.rb'], 'ruby'),
