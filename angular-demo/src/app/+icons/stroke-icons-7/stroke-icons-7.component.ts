...
@Component({
  selector: 'icons-stroke-icons-7', // tslint:disable-line
  templateUrl: './stroke-icons-7.component.html',
  styleUrls: [
    '../icons.scss',
    './stroke-icons-7.scss'
  ]
})
export class StrokeIcons7Component {
  icons = iconList.slice(0);

  constructor(private appService: AppService) {
    this.appService.pageTitle = 'Stroke Icons 7 - Icons';
  }
