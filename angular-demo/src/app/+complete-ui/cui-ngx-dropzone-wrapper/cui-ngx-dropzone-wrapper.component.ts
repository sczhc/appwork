...
@Component({
  selector: 'cui-ngx-dropzone-wrapper', // tslint:disable-line
  templateUrl: './cui-ngx-dropzone-wrapper.component.html',
  styleUrls: ['../../../vendor/libs/ngx-dropzone-wrapper/ngx-dropzone-wrapper.scss']
})
export class CuiNgxDropzoneWrapperComponent implements AfterViewInit {
  config = {
    url: '/upload',
    parallelUploads: 2,
    maxFilesize:     50000,
