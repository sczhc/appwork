...
@Component({
  selector: 'app-messages-v3-item',
  templateUrl: './messages-v3-item.component.html',
  styleUrls: [
    '../../../vendor/styles/pages/messages.scss',
  ]
})
export class MessagesV3ItemComponent implements AfterViewInit {
  constructor(private appService: AppService, private layoutService: LayoutService) {
    this.appService.pageTitle = 'Message item v3 - Pages';
  }
