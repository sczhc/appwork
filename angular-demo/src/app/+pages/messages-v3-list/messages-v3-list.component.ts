...
@Component({
  selector: 'app-messages-v3-list',
  templateUrl: './messages-v3-list.component.html',
  styleUrls: [
    '../../../vendor/styles/pages/messages.scss',
  ]
})
export class MessagesV3ListComponent implements AfterViewInit {
  constructor(private appService: AppService, private layoutService: LayoutService) {
    this.appService.pageTitle = 'Message list v3 - Pages';
  }
