...
@Component({
  selector: 'app-education-courses-v2',
  templateUrl: './education-courses-v2.component.html'
})
export class EducationCoursesV2Component {
  constructor(private appService: AppService) {
    this.appService.pageTitle = 'Courses v2 - Pages';
  }
