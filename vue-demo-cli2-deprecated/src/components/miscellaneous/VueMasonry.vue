<template>
  <div>
    <h4 class="font-weight-bold py-3 mb-4">
      <span class="text-muted font-weight-light">Miscellaneous /</span> Vue Masonry
    </h4>

    <hr class="border-light container-m--x mt-0 mb-4">

    <div v-masonry transition-duration="0.3s" item-selector=".masonry-item" :origin-left="isRTL ? 'false' : 'true'">
...
export default {
  name: 'miscellaneous-vue-masonry',
  metaInfo: {
    title: 'Vue Masonry - Miscellaneous'
  },
  data: () => ({
    items: [
      { title: 'Item 1', class: '' },
