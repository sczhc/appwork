<div class="ui-block">
    ...
    <h4 class="ui-block-heading">Checkboxes and radios without label text</h4>
    ...
    <div class="cui-example">
        <div class="cui-example-vertical-spacing-sm bg-dark p-4">
    ...
    <div class="cui-example cui-example-vertical-spacing-sm">
        ...
        <select class="form-control form-control-lg"><option>.form-control-lg</option></select>
        <select class="form-control"><option>Default select</option></select>
        <select class="form-control form-control-sm"><option>.form-control-sm</option></select>
    </div>
</div>
