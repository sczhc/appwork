<div class="ui-block">
    <h3 class="ui-block-heading">Buttons</h3>
    ...
    <h4 class="ui-block-heading">Outline</h4>
    ...
    <h4 class="ui-block-heading material-style-only">Flat (Material only)</h4>

    <div class="cui-example cui-example-inline-spacing material-style-only">
    ...
    <h4 class="ui-block-heading">Round</h4>

    <div class="cui-example cui-example-paragraph-spacing">
        <p>
    ...
    <h4 class="ui-block-heading">Extra-large</h4>
    ...
    <h4 class="ui-block-heading">Large</h4>
    ...
    <h4 class="ui-block-heading">Small</h4>
    ...
    <h4 class="ui-block-heading">Extra-small</h4>
    ...
    <h4 class="ui-block-heading">Icon-buttons</h4>

    <div class="cui-example cui-example-paragraph-spacing">
        <!-- Extra-large -->
        <p>
            <button type="button" class="btn icon-btn btn-xl btn-outline-primary"><span class="far fa-paper-plane"></span></button>
            <button type="button" class="btn icon-btn btn-xl btn-outline-secondary"><span class="oi oi-cloud-download"></span></button>
            ...
            <button type="button" class="btn icon-btn btn-xl btn-outline-danger"><span class="oi oi-cloud-download"></span></button>
            <button type="button" class="btn icon-btn btn-xl btn-outline-dark"><span class="pe-7s-users"></span></button>
        </p>

        <!-- Large -->
        <p>
            <button type="button" class="btn icon-btn btn-lg btn-outline-primary"><span class="far fa-paper-plane"></span></button>
            <button type="button" class="btn icon-btn btn-lg btn-outline-secondary"><span class="oi oi-cloud-download"></span></button>
            ...
            <button type="button" class="btn icon-btn btn-lg btn-outline-danger"><span class="oi oi-cloud-download"></span></button>
            <button type="button" class="btn icon-btn btn-lg btn-outline-dark"><span class="pe-7s-users"></span></button>
        </p>

        <!-- Default -->
        <p>
            <button type="button" class="btn icon-btn btn-outline-primary"><span class="far fa-paper-plane"></span></button>
            <button type="button" class="btn icon-btn btn-outline-secondary"><span class="oi oi-cloud-download"></span></button>
            ...
            <button type="button" class="btn icon-btn btn-outline-danger"><span class="oi oi-cloud-download"></span></button>
            <button type="button" class="btn icon-btn btn-outline-dark"><span class="pe-7s-users"></span></button>
        </p>

        <!-- Small -->
        <p>
            <button type="button" class="btn icon-btn btn-sm btn-outline-primary"><span class="far fa-paper-plane"></span></button>
            <button type="button" class="btn icon-btn btn-sm btn-outline-secondary"><span class="oi oi-cloud-download"></span></button>
            ...
            <button type="button" class="btn icon-btn btn-sm btn-outline-danger"><span class="oi oi-cloud-download"></span></button>
            <button type="button" class="btn icon-btn btn-sm btn-outline-dark"><span class="pe-7s-users"></span></button>
        </p>

        <!-- Extra-small -->
        <p>
            <button type="button" class="btn icon-btn btn-xs btn-outline-primary"><span class="far fa-paper-plane"></span></button>
            <button type="button" class="btn icon-btn btn-xs btn-outline-secondary"><span class="oi oi-cloud-download"></span></button>
            ...
            <button type="button" class="btn icon-btn btn-xs btn-outline-danger"><span class="oi oi-cloud-download"></span></button>
            <button type="button" class="btn icon-btn btn-xs btn-outline-dark"><span class="pe-7s-users"></span></button>
        </p>
    </div>

    <h4 class="ui-block-heading">Borderless icon-buttons</h4>

    <div class="cui-example cui-example-inline-spacing">
        <button type="button" class="btn icon-btn btn-xl btn-outline-primary borderless"><span class="far fa-paper-plane"></span></button>
        <button type="button" class="btn icon-btn btn-lg btn-outline-secondary borderless"><span class="oi oi-cloud-download"></span></button>
    ...
    <div class="cui-example cui-example-paragraph-spacing">
        ...
        <!-- MATERIAL_ONLY -->
        <!-- Flat (Material only) -->
        <p class="material-style-only">
            <button type="button" class="btn btn-primary md-btn-flat" disabled>Primary</button>
            <button type="button" class="btn btn-secondary md-btn-flat" disabled>Secondary</button>
            <button type="button" class="btn btn-default md-btn-flat" disabled>Default</button>
            <button type="button" class="btn btn-success md-btn-flat" disabled>Success</button>
            <button type="button" class="btn btn-warning md-btn-flat" disabled>Warning</button>
            <button type="button" class="btn btn-info md-btn-flat" disabled>Info</button>
            <button type="button" class="btn btn-danger md-btn-flat" disabled>Danger</button>
            <button type="button" class="btn btn-dark md-btn-flat" disabled>Dark</button>
        </p>
        <!-- /MATERIAL_ONLY -->
    </div>

    <h4 class="ui-block-heading">Single toggle</h4>
    ...
    <h4 class="ui-block-heading">Checkbox and radio</h4>
