<div class="ui-block">
    <h3 class="ui-block-heading">Cards</h3>

    <h4 class="ui-block-heading">Example</h4>

    <div class="cui-example">
        <div class="card" style="max-width: 20rem;">
            <img class="card-img-top" src="/img/bg/2.jpg" alt="Card image cap">
            <div class="card-body">
    ...
    <h4 class="ui-block-heading">Content types</h4>
    ...
    <div class="cui-example">
        <div class="row">
            ...
            <div class="col-md">
                ...
                <div class="card mb-3">
                    <img class="card-img-top" src="/img/bg/3.jpg" alt="Card image cap">
                    <div class="card-body">
                        <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                    </div>
                </div>
    ...
    <h4 class="ui-block-heading">Mixed</h4>

    <div class="cui-example">
        <div class="card" style="max-width: 20rem;">
            <img class="card-img-top" src="/img/bg/4.jpg" alt="Card image cap">
            <div class="card-body">
                <h4 class="card-title">Card title</h4>
                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
            </div>
    ...
    <h4 class="ui-block-heading">Header and footer</h4>
    ...
    <h4 class="ui-block-heading">Text alignment</h4>
    ...
    <h4 class="ui-block-heading">Navigation</h4>
    ...
    <h4 class="ui-block-heading material-style-only">Light navigation (Material only)</h4>
    ...
    <h4 class="ui-block-heading">Images</h4>
    ...
    <div class="cui-example">
        <div class="row">
            <div class="col-lg">
                ...
                <div class="card mb-3">
                    <img class="card-img-top" src="/img/bg/5.jpg" alt="Card image cap">
                    <div class="card-body">
                        <h4 class="card-title">Card title</h4>
            ...
            <div class="col-lg">
                ...
                <div class="card mb-3">
                    ...
                    <img class="card-img-bottom" src="/img/bg/1.jpg" alt="Card image cap">
                </div>
    ...
    <h4 class="ui-block-heading">Condenced</h4>
    ...
    <div class="cui-example">
        <div class="card card-condenced" style="max-width: 20rem;">
            ...
            <img class="w-100" src="/img/bg/3.jpg" alt="Card image cap">
            <div class="card-body">
                <h4 class="card-title">Card title</h4>
                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
            </div>
    ...
    <h4 class="ui-block-heading">Style variations</h4>
    ...
    <h4 class="ui-block-heading">Hover cards</h4>
    ...
    <h4 class="ui-block-heading">With elements</h4>
            ...
            <div class="col-md">
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-header with-elements">
                        <span class="card-header-title mr-2">Card header</span>
                        <div class="card-header-elements">
                            <button type="button" class="btn btn-xs btn-outline-primary"><span class="ion ion-md-add"></span> Add</button>
                            <button type="button" class="btn icon-btn btn-xs btn-success"><span class="ion ion-md-cloud-download"></span></button>
                        </div>
                        <div class="card-header-elements ml-md-auto">
                            <button type="button" class="btn btn-xs btn-outline-primary"><span class="ion ion-md-add"></span> Add</button>
                            <button type="button" class="btn icon-btn btn-xs btn-success"><span class="ion ion-md-cloud-download"></span></button>
    ...
    <h4 class="ui-block-heading">Card groups</h4>
    ...
    <h4 class="ui-block-heading">Card decks</h4>
    ...
    <h4 class="ui-block-heading">Card columns</h4>
