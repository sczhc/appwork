<div class="ui-block">
    <h3 class="ui-block-heading">Sparkline</h3>
    <a target="_blank" href="http://omnipotent.net/jquery.sparkline/#s-about" class="ui-block-description">http://omnipotent.net/jquery.sparkline/#s-about</a>

    <samp class="cui-example-code-static">
        &lt;!--
            $(...).sparkline(...) - Sparkline charts
            $(...).sparkline2(...) - Responsive sparkline charts (extension)
        --&gt;
