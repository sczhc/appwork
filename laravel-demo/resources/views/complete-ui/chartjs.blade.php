<div class="ui-block">
    <h3 class="ui-block-heading">Chart.js</h3>
    <a target="_blank" href="http://www.chartjs.org" class="ui-block-description">http://www.chartjs.org</a>
    ...
    <div class="cui-example cui-example-vertical-spacing-lg">
        ...
        <script>
            $(function() {
                ...
                // Resize charts on layout toggle
                //

                window.addEventListener('layouttoggle', function() {
                    graphChart.resize();
                    barsChart.resize();
                    radarChart.resize();
