...
@section('content')
    <div class="container px-0">
        ...
        <div class="card mt-5">
            ...
            <div class="p-4 p-md-5">
                <a href="javascript:void(0)" class="text-dark text-large font-weight-semibold">Java Developer</a>
                <div class="d-flex flex-wrap mt-3">
            ...
            <div class="p-4 p-md-5">
                <a href="javascript:void(0)" class="text-dark text-large font-weight-semibold">Infrastructure Administrator</a>
                <div class="d-flex flex-wrap mt-3">
            ...
            <div class="p-4 p-md-5">
                <a href="javascript:void(0)" class="text-dark text-large font-weight-semibold">Product Designer</a>
                <div class="d-flex flex-wrap mt-3">
            ...
            <div class="p-4 p-md-5">
                <a href="javascript:void(0)" class="text-dark text-large font-weight-semibold">Frontend Developer</a>
                <div class="d-flex flex-wrap mt-3">
