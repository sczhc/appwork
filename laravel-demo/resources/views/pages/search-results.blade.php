                    ...
                    <div class="card card-condenced mb-4">
                        <div class="card-body media align-items-center">
                            ...
                            <div class="media-body ml-3">
                                <a href="javascript:void(0)" class="text-dark font-weight-semibold mb-2">Mike Greene</a>
                                <div class="text-muted small">@mgreene</div>
                            </div>
                            <a href="javascript:void(0)" class="btn btn-outline-primary btn-round btn-sm md-btn-flat d-block">Follow</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="card card-condenced mb-4">
                        <div class="card-body media align-items-center">
                            ...
                            <div class="media-body ml-3">
                                <a href="javascript:void(0)" class="text-dark font-weight-semibold mb-2">Leon Wilson</a>
                                <div class="text-muted small">@lwilson</div>
                            </div>
                            <a href="javascript:void(0)" class="btn btn-success btn-round btn-sm md-btn-flat d-block">Following</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="card card-condenced mb-4">
                        <div class="card-body media align-items-center">
                            ...
                            <div class="media-body ml-3">
                                <a href="javascript:void(0)" class="text-dark font-weight-semibold mb-2">Allie Rodriguez</a>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="card card-condenced mb-4">
                        <div class="card-body media align-items-center">
                            ...
                            <div class="media-body ml-3">
                                <a href="javascript:void(0)" class="text-dark font-weight-semibold mb-2">Kenneth Frazier</a>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="card card-condenced mb-4">
                        <div class="card-body media align-items-center">
                            ...
                            <div class="media-body ml-3">
                                <a href="javascript:void(0)" class="text-dark font-weight-semibold mb-2">Nellie Maxwell</a>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="card card-condenced mb-4">
                        <div class="card-body media align-items-center">
                            ...
                            <div class="media-body ml-3">
                                <a href="javascript:void(0)" class="text-dark font-weight-semibold mb-2">Mae Gibson</a>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="card card-condenced mb-4">
                        <div class="card-body media align-items-center">
                            ...
                            <div class="media-body ml-3">
                                <a href="javascript:void(0)" class="text-dark font-weight-semibold mb-2">Alice Hampton</a>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="card card-condenced mb-4">
                        <div class="card-body media align-items-center">
                            ...
                            <div class="media-body ml-3">
                                <a href="javascript:void(0)" class="text-dark font-weight-semibold mb-2">Hallie Lewis</a>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="card card-condenced mb-4">
                        <div class="card-body media align-items-center">
                            ...
                            <div class="media-body ml-3">
                                <a href="javascript:void(0)" class="text-dark font-weight-semibold mb-2">Amanda Warner</a>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="card card-condenced mb-4">
                        <div class="card-body media align-items-center">
                            ...
                            <div class="media-body ml-3">
                                <a href="javascript:void(0)" class="text-dark font-weight-semibold mb-2">Wayne Morgan</a>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="card card-condenced mb-4">
                        <div class="card-body media align-items-center">
                            ...
                            <div class="media-body ml-3">
                                <a href="javascript:void(0)" class="text-dark font-weight-semibold mb-2">Belle Ross</a>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="card card-condenced mb-4">
                        <div class="card-body media align-items-center">
                            ...
                            <div class="media-body ml-3">
                                <a href="javascript:void(0)" class="text-dark font-weight-semibold mb-2">Arthur Duncan</a>
        ...
        <div class="tab-pane fade" id="search-videos">
            <div class="row">
                ...
                <div class="col-sm-6 col-md-4 col-xl-3 mb-4">
                    ...
                    <a href="javascript:void(0)" class="d-block text-dark mt-2">
