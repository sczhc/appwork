                ...
                <div class="media flex-wrap">
                    ...
                    <div class="media-body ml-sm-4">
                        <h5 class="mb-2">
                            ...
                            <a href="javascript:void(0)" class="text-dark">Complete Java Masterclass</a>&nbsp;
                        </h5>
                ...
                <div class="media flex-wrap">
                    ...
                    <div class="media-body ml-sm-4">
                        <h5 class="mb-2">
                            ...
                            <a href="javascript:void(0)" class="text-dark">The Complete Web Developer Course 2.0</a>&nbsp;
                        </h5>
                        <div class="d-flex flex-wrap align-items-center mb-2">
                            <div class="text-muted small">
                                <i class="ion ion-md-time text-primary"></i>
                ...
                <div class="media flex-wrap">
                    ...
                    <div class="media-body ml-sm-4">
                        <h5 class="mb-2">
                            ...
                            <a href="javascript:void(0)" class="text-dark">Python for Beginners: Learn Python Programming</a>&nbsp;
                        </h5>
                        <div class="d-flex flex-wrap align-items-center mb-2">
                            <div class="text-muted small">
                                <i class="ion ion-md-time text-primary"></i>
                ...
                <div class="media flex-wrap">
                    ...
                    <div class="media-body ml-sm-4">
                        <h5 class="mb-2">
                            ...
                            <a href="javascript:void(0)" class="text-dark">Become a Web Developer from Scratch</a>&nbsp;
                        </h5>
                        <div class="d-flex flex-wrap align-items-center mb-2">
                            <div class="text-muted small">
                                <i class="ion ion-md-time text-primary"></i>
                ...
                <div class="media flex-wrap">
                    ...
                    <div class="media-body ml-sm-4">
                        <h5 class="mb-2">
                            ...
                            <a href="javascript:void(0)" class="text-dark">Become a Certified Web Developer</a>&nbsp;
                        </h5>
                        <div class="d-flex flex-wrap align-items-center mb-2">
                            <div class="text-muted small">
                                <i class="ion ion-md-time text-primary"></i>
                ...
                <div class="media flex-wrap">
                    ...
                    <div class="media-body ml-sm-4">
                        <h5 class="mb-2">
                            ...
                            <a href="javascript:void(0)" class="text-dark">Full stack Universal React with Redux, Node js and MongoDB</a>&nbsp;
                        </h5>
                        <div class="d-flex flex-wrap align-items-center mb-2">
                            <div class="text-muted small">
                                <i class="ion ion-md-time text-primary"></i>
