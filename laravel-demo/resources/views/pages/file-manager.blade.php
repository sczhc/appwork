    ...
    <div class="file-manager-container file-manager-col-view">
        ...
        <div class="file-item">
            ...
            <div class="file-item-actions btn-group">
                <button type="button" class="btn btn-default btn-sm btn-round icon-btn borderless md-btn-flat hide-arrow dropdown-toggle" data-toggle="dropdown"><i class="ion ion-ios-more"></i></button>
