...
@section('content')
    <h4 class="d-flex justify-content-between align-items-center w-100 font-weight-bold py-3 mb-4">
        <div>Teams</div>
        <button type="button" class="btn btn-primary btn-round d-block"><span class="ion ion-md-add"></span>&nbsp; Add team</button>
    </h4>
            ...
            <div class="card mb-4">
                <div class="card-body pb-0">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            <a href="javascript:void(0)" class="text-dark text-big font-weight-semibold">Frontend</a>
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3"><a href="javascript:void(0)" class="text-dark font-weight-semibold">Frontend Development</a></div>
        ...
        <div class="col-sm-6 col-xl-4">
            ...
            <div class="card mb-4">
                <div class="card-body pb-0">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            <a href="javascript:void(0)" class="text-dark text-big font-weight-semibold">Backend</a>
                            <span class="badge badge-danger align-text-bottom ml-1">Busy</span>
                        </div>
                        <div class="btn-group team-actions">
                            <button type="button" class="btn btn-sm btn-default icon-btn borderless btn-round md-btn-flat dropdown-toggle hide-arrow" data-toggle="dropdown">
                ...
                <div class="card-body">
                    <div class="text-muted small">Current project</div>
                    <div class="mb-3"><a href="javascript:void(0)" class="text-dark font-weight-semibold">Website</a></div>
                    <div class="d-flex justify-content-between align-items-center small">
        ...
        <div class="col-sm-6 col-xl-4">
            ...
            <div class="card mb-4">
                <div class="card-body pb-0">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            <a href="javascript:void(0)" class="text-dark text-big font-weight-semibold">Design</a>
        ...
        <div class="col-sm-6 col-xl-4">
            ...
            <div class="card mb-4">
                <div class="card-body pb-0">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            <a href="javascript:void(0)" class="text-dark text-big font-weight-semibold">Marketing</a>
                            <span class="badge badge-danger align-text-bottom ml-1">Busy</span>
                        </div>
                        <div class="btn-group team-actions">
                            <button type="button" class="btn btn-sm btn-default icon-btn borderless btn-round md-btn-flat dropdown-toggle hide-arrow" data-toggle="dropdown">
                ...
                <div class="card-body">
                    <div class="text-muted small">Current project</div>
                    <div class="mb-3"><a href="javascript:void(0)" class="text-dark font-weight-semibold">example.com SEO</a></div>
                    <div class="d-flex justify-content-between align-items-center small">
        ...
        <div class="col-sm-6 col-xl-4">
            ...
            <div class="card mb-4">
                <div class="card-body pb-0">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            <a href="javascript:void(0)" class="text-dark text-big font-weight-semibold">Graphic</a>
                            <span class="badge badge-success align-text-bottom ml-1">Available</span>
                        </div>
                        <div class="btn-group team-actions">
                            <button type="button" class="btn btn-sm btn-default icon-btn borderless btn-round md-btn-flat dropdown-toggle hide-arrow" data-toggle="dropdown">
