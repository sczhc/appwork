...
@section('scripts')
    ...
    <script src="{{ mix('/js/misc_idle-timer.js') }}"></script>
@endsection

@section('content')
    <h4 class="font-weight-bold py-3 mb-4">
        <span class="text-muted font-weight-light">Miscellaneous /</span> Idle Timer
    </h4>
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <br>
            <br>
            <textarea rows="10" cols="30" id="idletimer-doc-Status" class="form-control"></textarea>
            <br>
        </div>
        <div class="col-md-6">
            <h5>Element
            ...
            <br>
            <br>
            <textarea rows="10" cols="30" id="idletimer-el-Status" class="form-control"></textarea>
            <br>
        </div>
    </div>
@endsection