            ...
            <div class="collapse navbar-collapse" id="navbar-example-14">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item mega-dropdown">
                        <a class="nav-link dropdown-toggle navbar-example-14-mega-dropdown" href="javascript:void(0)" data-toggle="mega-dropdown">Mega (click)</a>
                    ...
                    <li class="nav-item mega-dropdown">
                        <a class="nav-link dropdown-toggle navbar-example-14-mega-dropdown" href="javascript:void(0)" data-toggle="mega-dropdown" data-trigger="hover">Mega (hover)</a>
                        <div class="dropdown-menu p-4">
                            <div class="alert alert-info">
                                Add <code>.mega-link</code> class to the element to close menu on click
                            </div>
            ...
            <div class="container position-relative">
                ...
                <div class="collapse navbar-collapse" id="navbar-example-15">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item mega-dropdown">
                            <a href="javascript:void(0)" class="nav-link dropdown-toggle navbar-example-15-mega-dropdown">Mega (click)</a>
                        ...
                        <li class="nav-item mega-dropdown">
                            <a href="javascript:void(0)" class="nav-link dropdown-toggle navbar-example-15-mega-dropdown" data-trigger="hover">Mega (hover)</a>
                            <div class="dropdown-menu p-4 mt-2">
                                <div class="alert alert-info">
                                    Add <code>.mega-link</code> class to the element to close menu on click
                                </div>
