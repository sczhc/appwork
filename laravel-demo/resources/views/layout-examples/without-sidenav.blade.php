...
@section('content')
    <h4 class="font-weight-bold py-3 mb-4">
        <span class="text-muted font-weight-light">Layouts /</span> Without sidenav
    </h4>

    <div class="layout-example-block layout-example-block-1 layout-example-block-1-no-sidenav">
